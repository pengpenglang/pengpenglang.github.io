...
function bot_ui_ini() {
    ...
    botui.message.add({
        ...
        botui.message.add({
            delay: 1100,
            content: "这里是 pengpenglang😀"
        }).then(function () {
            botui.message.add({
                delay: 1100,
                content: "一个正在努力学习的IT小白😐"
            }).then(function () {
                botui.action.button({
                    delay: 1600,
                    action: [{
    ...
    var sure = function () {
        ...
        secondpart = function () {
            botui.message.add({
                delay: 1500,
                content: "就读于帝都某所末流211"
            }).then(function () {
                botui.message.add({
                    delay: 1500,
                    content: "是计算机科学与技术专业的一名大二狗💪"
                }).then(function () {
                    botui.message.add({
                        delay: 1200,
                        content: "将敲代码看作是一种享受"
                        ...
                        botui.message.add({
                            delay: 1500,
                            content: "在不懈学习 C++，并在业余时间瞎搞搞 HTML/CSS"
                        }).then(function () {
                            botui.message.add({
                                delay: 1500,
        ...
        fourthpart = function () {
            botui.message.add({
                delay: 1e3,
                content: "因为内容保存在本地电脑中受限太大，本人就决定趁着现在还有头发将所学所想记录下来 "
            }).then(function () {
                botui.message.add({
                    delay: 1100,
